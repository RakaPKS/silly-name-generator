...
print("This is a silly random name generator.")
...
while unhappy:
    ...
    response = pyinput.inputYesNo(f"Your generated name is: {first_name} {last_name}. Are you content with this "
                              f"name? ")
    if response == "yes":
        unhappy = False
